...
export type DinoDetailsFragment = {
  __typename?: 'Dinosaur';
  id?: string | null;
  name: string;
  genus: string;
...
export type CreateDinoMutation = {
  __typename?: 'Mutation';
  createDino: {
    __typename?: 'Dinosaur';
    id?: string | null;
...
export type UpdateDinoMutation = {
  __typename?: 'Mutation';
  updateDino: {
    __typename?: 'Dinosaur';
    id?: string | null;
...
export type DeleteDinoMutation = {
  __typename?: 'Mutation';
  deleteDino: { __typename?: 'Dinosaur'; id?: string | null };
};
...
export class AllDinosaursGQL extends Apollo.Query<
  AllDinosaursQuery,
  AllDinosaursQueryVariables
> {
...
export class CreateDinoGQL extends Apollo.Mutation<
  CreateDinoMutation,
  CreateDinoMutationVariables
> {
...
export const UpdateDinoDocument = gql`
  mutation UpdateDino(
    $data: DinosaurUpdateInput!
    $where: DinosaurWhereUniqueInput!
  ) {
...
export class UpdateDinoGQL extends Apollo.Mutation<
  UpdateDinoMutation,
  UpdateDinoMutationVariables
> {
...
export const DeleteDinoDocument = gql`
...
export class DeleteDinoGQL extends Apollo.Mutation<
  DeleteDinoMutation,
